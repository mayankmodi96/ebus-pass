    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1>Senior-citizen apply pass details</h1>
                        <table class="table">
                            <tr>
                                <td>ID</td>
                                <td>Senior proof id</td>
                                <td>Senior proof image</td>
                                <td>proof of home</td>
                                <td>proof home image</td>
                                <td>month of pass</td>
                            </tr>
                            <?php
                            $select = mysql_query("SELECT * FROM renew_senior");
