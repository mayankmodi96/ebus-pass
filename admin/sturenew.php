    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1>Student apply pass details</h1>
                        <table class="table">
                            <tr>
                                <td>ID</td>
                                <td>Schoo/college name</td>
                                <td>School/college address</td>
                                <td>Contact number</td>
                                <td>Bonofied image</td>
                                <td>term start</td>
                                <td>term end</td>
                                <td>Starting place</td>
                                <td>change place</td>
                                <td>alight place</td>
                                <td>travel bus number</td>
                                <td>change bus number</td>
                                <td>month of pass</td>
                            </tr>
                            <?php
                            $select = mysql_query("SELECT * FROM renew_student");
                            while($row = mysql_fetch_object($select))
                            {
                                echo "<tr>
                                        ...
                                        <td>$row->scaddress</td>
                                        <td>$row->sc_cno</td>
                                        <td><img src='' width='100' height='70'></td>
                                        <td>$row->tstart</td>
                                        <td>$row->tend</td>
                                        <td>$row->place_sit</td>
                                        <td>$row->change_place</td>
                                        <td>$row->alight_place</td>
                                        <td>$row->trano</td>
                                        <td>$row->changeno</td>
                                        <td>$row->passmonth</td>
                                     </tr>";
