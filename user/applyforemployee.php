...
if(isset($_POST['save']))
{
	 ...
	 
	{
				...
				'employee/userphoto/'.$_FILES['userfile']['name']))
		{
			...
			$insert = mysql_query("INSERT INTO emp_reg_pass(id,category,fname,mname,lname,gender,dob,address,pin,cno,eid,adharno,user_image,adhar_image,place_sit,change_place,alight_place,trano,changeno,jstart,jend,passmonth)
									VALUES('$usid','$category','$fname','$mname','$lname','$gender','$dob','$address','$pin','$cno','$eid','$adharno','$uphoto','$aphoto','$place_sit','$change_place','$alight_place','$trano','$changeno','$jstart','$jend','$passmonth')");
			if($insert)
			{
...
<!-- start-smoth-scrolling -->
	...
	<body>
		...
		<div class="container hstyle">
			<h3>Apply pass for employee</h3>
			<h5>* All details are mandatory field.</h5>
			<h5>* Image upload size less than(<) 500kb.</h5>
			<div class="col-md-12">
			<form method="post" name="applyforemployee" enctype="multipart/form-data">
				<div class="form-box">
					...
					<div class="row">
						...
						<div class="form-group col-md-4">
							...
							<input type="date" class="form-control" name="dob" requried=""></input>	
						</div>
						<div class="form-group col-md-4">
					...
					<div class="row">
						...
						<div class="form-group col-md-4">
							...
							<input type="time" class="form-control" name="jend" requried="" title="Please enter valid time"></input>	
						</div>
					</div>
					<h4>Pass Details</h4>
					<div class="row">
