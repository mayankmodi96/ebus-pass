...
if(isset($_POST['save']))
{
					...
					&& ($_FILES['bonofile']['size'] < 5000000))
	{
		if(file_exists('handicap/student/bonofiedphoto/'.$_FILES['bonofile']['name']))
		 ...
		 $insert = mysql_query("INSERT INTO renew_handi_stu(stu_handi_pass_id,scname,scaddress,sc_cno,bono_image,tstart,tend,place_sit,change_place,alight_place,trano,changeno,passmonth)
				VALUES('$handistuid','$scname','$scaddress','$sc_cno','$bonophoto','$tstart','$tend','$place_sit','$change_place','$alight_place','$trano','$changeno','$passmonth')");
...
<!-- start-smoth-scrolling -->
	...
	<body>
		...
		<div class="container hstyle">
			<h3>ReNew for handicap student</h3>
			...
			<?php
			 	$select = mysql_query("SELECT * FROM stu_handi_pass WHERE stu_handi_pass_id='$handistuid'");
			 	$passid = mysql_fetch_object($select);
			?>
				<div class="form-box">
					<div class="row">
							<div class="form-group col-md-4">
								<h4><?php echo "Your Pass id:   " .$passid->stu_handi_pass_id?></h4>
							</div>
						</div>
