				  ...
				  <div class="passstyle">
					<table class="table">
						<tr>
							...
							<td><img src="<?php echo 'employee/userphoto/'.$passid->user_image; ?>" class="img-responsive" alt="Cinque Terre" height="80" width="90"></td>
						</tr>
					</table>
					<table class="table">
						<tr>
							<td>Pass number</td>
							<td>:</td>
							<td><?php echo $passid->emp_reg_pass_id; ?></td>
							
							
							<td><?php echo "Start Date:".$passid->stdate;?></td>
							<td></td>
						</tr>
						<tr>
							<td>Name</td>
