...
if(isset($_POST['save']))
{
	...
	$sql = mysql_query("INSERT INTO feedback(id,name,email,subject,message) 
						VALUES ('$usid','$name','$email','$subject','$message')");
	if($sql)
	{
		...
		<div class="contact">
			...
			<div class="container">
				<div class="contact-info">
					<h3 class="c-text">Give your feedback</h3>
				</div>
				<div class="contact-grids">
					...
					<div class="contact-info-grids">
							<form method="post" name="feedback">
								...
								<input type="text" placeholder="Subject"  name="subject" requried="" pattern="[A-Za-z]+">
								<textarea placeholder="Message" name="message" requried="" pattern="[A-Za-z]+"></textarea>
