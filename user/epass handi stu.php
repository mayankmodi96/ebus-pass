				  ...
				  <div class="passstyle">
					<table class="table">
						<tr>
							...
							<td align="center">
								<p>ebuspass</p>
								City bus Transport, Ahmedabad<br>
								<div class=""><?php echo "<b>$passid->category</b>"."Pass"; ?></div><br>
								<div class=""><?php echo "Pass Date:"; ?></div>
							</td>
							
							<td><img src="<?php echo 'handicap/student/userphoto/'.$passid->user_image; ?>" class="img-responsive" alt="Cinque Terre" height="80" width="90"></td>
						</tr>
					</table>
					<table class="table">
						<tr>
							<td>Pass number</td>
							<td>:</td>
							<td><?php echo $passid->stu_handi_pass_id; ?></td>
							<td></td>
							<td></td>
							<td><?php echo "Date:".$passid->tend;?></td>
						</tr>
						<tr>
							<td>Name</td>
							<td>:</td>
