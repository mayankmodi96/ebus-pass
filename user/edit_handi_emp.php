...
include('db/config.php');
	...
	$select = mysql_query("SELECT * FROM emp_handi_pass WHERE emp_handi_pass_id='$id'");
	...
	if(isset($_POST['update']))
	{
		...
		$sql = mysql_query("UPDATE emp_handi_pass SET fname='$fname',mname='$mname',lname='$lname',gender='$gender',dob='$dob',address='$address',pin='$pin',cno='$cno',eid='$eid',adharno='$adharno' WHERE emp_handi_pass_id='$id'");
				if($sql)
				{
