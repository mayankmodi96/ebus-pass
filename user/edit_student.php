...
include('db/config.php');
	...
	$select = mysql_query("SELECT * FROM stu_reg_pass WHERE stu_reg_pass_id='$id'");
	...
	if(isset($_POST['update']))
	{
		...
		$sql = mysql_query("UPDATE stu_reg_pass SET fname='$fname',mname='$mname',lname='$lname',gender='$gender',dob='$dob',address='$address',pin='$pin',cno='$cno',eid='$eid',adharno='$adharno' WHERE stu_reg_pass_id='$id'");
				if($sql)
				{
				...
				<div class="form-box">
					...
					<div class="row">
						...
						<div class="form-group col-md-4">
							...
							<input type="text" class="form-control" name="address" requried="" pattern="[A-Za-z]+" value="<?php echo $row->address; ?>"></input>
						</div>
						<div class="form-group col-md-4">
						...
						<div class="form-group col-md-4">
							...
							<input type="text" class="form-control" name="cno" requried="" pattern="[A-Za-z]+" value="<?php echo $row->cno; ?>"></input>
						</div>
						<div class="form-group col-md-4">
