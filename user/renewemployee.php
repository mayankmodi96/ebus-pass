...
if(isset($_POST['save']))
{
	...
	$insert = mysql_query("INSERT INTO renew_employee(emp_reg_pass_id,place_sit,change_place,alight_place,trano,changeno,jstart,jend,passmonth)
									VALUES('$empid','$place_sit','$change_place','$alight_place','$trano','$changeno','$jstart','$jend','$passmonth')");
			if($insert)
			{
...
<!-- start-smoth-scrolling -->
	...
	<body>
		...
		<div class="container hstyle">
			<h3>ReNew pass for Employee</h3>
			<h5>* All details are mandatory field.</h5>
			<h5>* Image upload size less than(<) 500kb.</h5>
			<div class="col-md-12">
				<form method="post" name="renewemployee" enctype="multipart/form-data">
				<?php
				 	$select = mysql_query("SELECT * FROM emp_reg_pass WHERE emp_reg_pass_id='$empid'");
				 	$passid = mysql_fetch_object($select);
				 ?>
					<div class="form-box">
						<div class="row">
							<div class="form-group col-md-4">
								<h4><?php echo "Your Pass id:   " .$passid->emp_reg_pass_id?></h4>
							</div>
						</div>
					<h4>Bus Details</h4>
					<div class="row">
