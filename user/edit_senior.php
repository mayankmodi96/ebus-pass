...
include('db/config.php');
	...
	$select = mysql_query("SELECT * FROM sen_reg_pass WHERE sen_reg_pass_id='$id'");
	...
	if(isset($_POST['update']))
	{
		...
		$adharno = $_POST['adharno'];
			...
			$sql = mysql_query("UPDATE sen_reg_pass SET fname='$fname',mname='$mname',lname='$lname',gender='$gender',dob='$dob',address='$address',pin='$pin',cno='$cno',eid='$eid',adharno='$adharno' WHERE sen_reg_pass_id='$id'");
				if($sql)
				{
