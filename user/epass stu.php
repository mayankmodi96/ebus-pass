					...
					<table class="table">
						<tr>
							...
							<td align="center">
								...
								<div class=""><?php echo "<b>$passid->pass_category</b>"."Pass"; ?></div>
								<div class=""><?php echo "Pass Date:"; ?></div>
							</td>
							
							<td><img src="<?php echo 'student/userphoto/'.$passid->user_image; ?>" class="img-responsive" alt="Cinque Terre" height="80" width="90"></td>
						</tr>
					</table>
					<table class="table">
						<tr>
							<td>Pass number</td>
							<td>:</td>
							<td><?php echo $passid->stu_reg_pass_id; ?></td>
							<td></td>
							<td></td>
							<td><?php echo "Date:"?></td>
						</tr>
